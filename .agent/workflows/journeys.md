...
1. `docs/planning/01-product-brief.md` (Personas)
2. `docs/planning/02-prd.md` (Requisitos Funcionais)
...
**Output:** `docs/planning/05-user-journeys.md`
...
**Arquivo:** `docs/planning/05-user-journeys.md`
